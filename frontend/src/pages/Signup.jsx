...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Brand Side */}
      <div className="hidden lg:flex flex-1 bg-sage text-white p-12 flex-col justify-between relative">
        <div>
          ...
          <p className="text-white/80 text-lg max-w-sm leading-relaxed">
            Join runners training smarter with AI-powered coaching.
          </p>
        </div>
        <div className="text-white/60 text-sm space-y-2">
          <p>Connect your Strava data</p>
          <p>Set your race goals</p>
          <p>Get personalized coaching</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-8 bg-bg-app">
        ...
        >
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-text-primary mb-1" style={{ fontFamily: 'var(--font-heading)' }}>Create your account</h1>
